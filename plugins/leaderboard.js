...
┃ 
${sortedExp.slice(0, len).map(({ jid, exp }, i) => `┃ *〲 ${i + 1}. ${participants.some(p => jid === p.jid) ? `(${conn.getName(jid)}) wa.me/` : '@'}${jid.split`@`[0]} *${exp} Exp*`).join`\n`}
┃ *─★‧ﾟ
╰━━━━━━━━⸙
╭━━•✵ ⃟  ⃟  ⃟✵•
┃
...
┃
${sortedLim.slice(0, len).map(({ jid, limit }, i) => `┃ *〲 ${i + 1}. ${participants.some(p => jid === p.jid) ? `(${conn.getName(jid)}) wa.me/` : '@'}${jid.split`@`[0]} *${limit} Limit*`).join`\n`}
┃ *─★‧ﾟ
╰━━━━━━━━⸙
╭━━•✵ ⃟  ⃟  ⃟✵•
┃
...
┃
${sortedLevel.slice(0, len).map(({ jid, level }, i) => `┃ *〲 ${i + 1}. ${participants.some(p => jid === p.jid) ? `(${conn.getName(jid)}) wa.me/` : '@'}${jid.split`@`[0]} *Level ${level}*`).join`\n`}
┃ *─★‧ﾟ
╰━━━━━━━━⸙`.trim()
