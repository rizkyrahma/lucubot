...
`.trim()
    ...
    await this.send2ButtonLoc(jid, await (await fetch(pp)).buffer(), banned ? 'jiaks ke banned' : str, m, false, watermark, 'Off Welcome' : 'Off Goodbye', '.0 w', null, { contextInfo: { mentionedJid } }
